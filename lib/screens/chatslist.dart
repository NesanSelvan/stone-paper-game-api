...
import 'package:chat_hub/screens/chatpage.dart';
          ...
          actions: [
            IconButton(
                onPressed: () {
                  ...
                  int hours = int.parse(
                      time24.split("T")[1].split(".")[0].split(":")[0]);
                  var AmOrPm = hours >= 12 ? 'pm' : 'am';
                  hours = (hours % 12);
                  var minutes = int.parse(
                      time24.split("T")[1].split(".")[0].split(":")[1]);
                  print(minutes);
  ...
  Widget get bottomNavigationBar {
    return Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: Colors.green.shade300, spreadRadius: 0.2, blurRadius: 2),
          ],
        ),
        child: ClipRRect(
          borderRadius: const BorderRadius.only(
          ...
          child: Theme(
            data: Theme.of(context).copyWith(canvasColor: Colors.green.shade50),
                ...
                BottomNavigationBarItem(
                  icon: Image.asset(
                    ...
                    color: _selectedTabIndex == 1
                        ? Colors.green
                        : Colors.grey.shade500,
                    // color: Colors.?, // <-- This works for shifting
                  ),
                  label: 'Groups',
                ),
